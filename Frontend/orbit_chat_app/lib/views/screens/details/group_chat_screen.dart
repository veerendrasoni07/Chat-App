...
//                 children: [
//                   GestureDetector(
//                     onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (_)=>GroupScreen(groupMembers: widget.groupMembers.toList(),groupId: widget.groupId,groupName: widget.fullname,groupAdmin: widget.groupAdmin.toList(),))),
//                     child: AutoSizeText(
//                       widget.fullname,
