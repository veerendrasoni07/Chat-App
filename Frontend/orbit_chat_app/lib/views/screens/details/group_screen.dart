...
import 'package:orbit_chat_app/provider/group_controller_provider.dart';
...
class GroupScreen extends ConsumerStatefulWidget {
  ...
  const GroupScreen({super.key,required this.groupId, required this.groupMembers,required this.groupAdmin,required this.groupName});
...
class _GroupScreenState extends ConsumerState<GroupScreen> {
            ...
            SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  Center(child: _avatar(context,widget.groupName,80.r)),
      ...
      child: _glassTile(
        ...
        child: Row(
          children: [
            ...
            },child: _avatar(context, a.fullname,26.r)),
  ...
  Widget _avatar(BuildContext context,String name,double size) {
    return Hero(
      tag: name,
      child: CircleAvatar(
        radius: size,
